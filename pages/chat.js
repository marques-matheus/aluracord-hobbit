...
export default function ChatPage() {
  ...
  React.useEffect(() => {
    ...
    realTime((eventType, msg) => {
      if (eventType === "INSERT") {
        ...
        setListamensagens((valorAtual) => {
          return valorAtual.filter((msgSelecioanda) => {
  ...
  return (
    ...
    >
      ...
      >
        <Header dados={dadosGit} user={usuarioLogado} />
        <Box
          styleSheet={{
            position: "relative",
            display: "flex",
        ...
        >
          ...
          > 
            ...
            <div style={{
              ...
              <FaUserFriends size={25}  />: {props.dados.followers}
            </div>
          </Text>
        </Box>
      </Box>
...
function MessageList(props) {
  ...
  function handlerDeleteMsg(id) {
    ...
    props.SupabaseClient.from("mensagens")
      .delete()
      .match({ id: id })
      .then(() => {
